...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://3janocxpuk.execute-api.us-east-1.amazonaws.com/test2';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['image', 'x-amz-meta-customLabels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['image', ]),
            body: body
        };
